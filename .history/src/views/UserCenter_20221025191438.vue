      ...
      <div class="topDiv" ref="topDiv" @touchmove.prevent>
         ...
         <div class="userImg">
            <el-upload
               ...
               action="http://4j89034j54.zicp.vip:8988/elm/user/update"
...
export default {
   data() {
      ...
      var validatePass = (rule, value, callback) => {
         if (value === "") {
            ...
            this.$axios
               .post(
                  "http://4j89034j54.zicp.vip:8988/elm/user/checkPassword",
                  this.$qs.stringify({
      ...
      submitForm(formName) {
         this.$refs[formName].validate((valid) => {
            if (valid) {
               ...
               this.$axios({
                  url: "http://4j89034j54.zicp.vip:8988/elm/user/update",
                  method: "POST",
                  headers: {
   ...
   created() {
      ...
      //获取用户评论信息
      this.$axios
         .get("http://4j89034j54.zicp.vip:8988/elm/comment/list/" + this.user.userId)
         .then((response) => {

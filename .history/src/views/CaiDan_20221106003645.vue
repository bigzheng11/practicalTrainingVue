            ...
            <el-form :model="form" style="margin: 30px">
               ...
               <el-form-item label="图片" :label-width="formLabelWidth">
                  <el-upload
                     ...
                     action="http://4j89034j54.zicp.vip:8988/elm/comment/insert"
                     :data="{
...
export default {
   ...
   methods: {
      ...
      submitCommment() {
         this.$axios({
            method: "post",
            url: "http://4j89034j54.zicp.vip:8988/elm/comment/insert",
            headers: {
      ...
      saveCart(indexOut, indexIn, foodId) {
         this.$axios
            .post(
               "http://4j89034j54.zicp.vip:8988/elm/cart/saveCart",
               this.$qs.stringify({
                  businessId: this.businessId,
                  foodId: foodId,
                  userId: this.user.userId,
      ...
      removeCart(indexOut, indexIn, foodId) {
         this.$axios //delete方式请求，传递参数是一个JSON对象，使用data属性传递
            .delete("http://4j89034j54.zicp.vip:8988/elm/cart/removeCart", {
               data: {
                  businessId: this.businessId,
                  foodId: foodId,
                  userId: this.user.userId,
   ...
   created() {
      ...
      this.$axios
         .get(
            "http://4j89034j54.zicp.vip:8988/elm/business/searchBusinessFood/" +
               this.businessId
         )
         .then((response) => {
      ...
      this.$axios
         .get(
            "http://4j89034j54.zicp.vip:8988/elm/foodClassify/getBusinessId/" +
               this.businessId
         )
         .then((response) => {
      ...
      this.$axios
         .get(
            "http://4j89034j54.zicp.vip:8988/elm/comment/getBusinessId/" +
               this.businessId
         )
         .then((response) => {
            console.log(

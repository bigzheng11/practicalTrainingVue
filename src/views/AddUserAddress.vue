    ...
    <ul class="form-box">
      ...
      <li>
        ...
        <div class="content" style="font-size: 3vw;">
          <input type="radio" value="1" v-model="deliveryAddress.contactSex"
                 style="width:6vw;height:3.2vw;">男
          <input type="radio" value="0" v-model="deliveryAddress.contactSex "
  ...
  export default {
    ...
    methods: {
      ...
      addUserAddress() {
        ...
        //ajax请求，保存地址信息
        this.$axios
          .post('http://47.101.196.82:8988/elm/delivery/saveAddress', this.$qs.stringify(this.deliveryAddress))
          .then((response) => {
